    ...
    <div class="upload">
      ...
      <div class="example-btn">
        <file-upload
          ...
          post-action="http://192.168.137.197:1025/api/vuepload"
          ...
          extensions="gif,jpg,jpeg,png,webp,rar,exe"
          accept="image/png,image/gif,image/jpeg,image/webp
                ,video/mp4,video/m3u8,video/rmvb,video/avi
                ,video/swf,video/3gp,video/mkv,video/flv
                ,audio/mp3,audio/wav,audio/wma,audio/ogg
                ,audio/aac,audio/flac,document/doc,document/txt
                ,document/docx,document/pages,document/epub,document/pdf
                ,document/numbers,document/csv,document/xls,document/xlsx
                ,document/keynote,document/ppt,document/pptx"
          :multiple="true"
          :size="1024 * 1024 * 1"
          v-model="files"
