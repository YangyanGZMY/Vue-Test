        ...
        <div ref="scrollBody" class="tags-inner-scroll-body" :style="{left: tagBodyLeft + 'px'}">
            <transition-group name="taglist-moving-animation">
                <Tag 
                    ...
                    :closable="item.name==='testApple'?false:true"
...
export default {
    ...
    methods: {
        ...
        linkTo (item) {
            if (item.name == 'testApple' ||item.name == 'testBanana' ||item.name == 'testPich' ||item.name == 'testPear') {
                this.$store.commit('concatRouter', item.name);
                this.$store.commit('openName', item.name);
                this.$emit("openNameChange")
            }
            let routerObj = {};
